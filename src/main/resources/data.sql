...
INSERT INTO users (id, username, password, first_name, last_name, email, gender, phone, company_id, activated) VALUES (1, 'SuperDzej', '$2a$10$Vs28N6SlCcb78RtesA8okeKOYkXG76VFGwTnMIxmeHRV54ojlyvAG', 'Dzej', 'Muha', 'dmuharemov1@etf.unsa.ba', null, null, null,  1) WHERE NOT EXISTS (SELECT * FROM users);
